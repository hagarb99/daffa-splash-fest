...
const dict = {
  ar: {
    ...
    hero: {
      ...
      subtitle:
        "أسوان هتعيش أقوى صيف!\nاستعد لـ 5 أيام مليانين ألعاب مائية، مسابقات حماسية، تحديات، وجوايز، في أجواء هتخليك تعيش تجربة مختلفة من أول لحظة لآخر يوم.",
      cta: "احجز تجربتك",
      ctaSecondary: "استكشف الأنشطة",
    },
    sections: {
      experiences: "تجربة المهرجان",
      curated: "فعاليات اليوم",
      curatedSub: "أنشطة مسائية وصباحية تناسب الكل.",
      morning: "أنشطة الصباح",
      night: "أنشطة المساء",
      sponsors: "Our Sponsors",
      cities: "رحلة المدن",
      citiesSub: "ثماني مدن، عشرة أيام لكل مدينة، تجربة لا تنتهي.",
      marketplace: "المطاعم والكافيهات",
      marketplaceSub: "المتاحة لدينا في المهرجان.",
      cta: "احجز الآن",
